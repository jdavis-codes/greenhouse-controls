...
#include <WiFi.h>
#include <FastBot2.h>
// NOTE: RTClib is removed for the Waveshare board as it relies on the internal WS_RTC PCF85063 driver.
// Timestamping now relies purely on unix epoch uint32_t seconds (from the built-in time mechanisms)
// #include <RTClib.h>
#include <FFat.h>
#include <SD.h>
#include "LogBuffer.h"
...
private:
    ...
    // Helpers
    String formatTime(uint32_t unixTime);
};
